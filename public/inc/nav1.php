...
<div class="navbar-fixed">
    ...
    <header class="z-depth-0 hide-on-med-and-down navHeader grey darken-4" style="padding: 10px 0; margin: 0 !important;">
        <div class="nav-content white-text row center">
            <div class="navlinks container col s8 l8 m8" style="padding: 0 2%;">
                ...
                <div class="links" style="display: flex; margin: 0 10px;">
                    <a href="https://www.facebook.com/Syke-World-118621122865541/" class="white-text" style="margin: 0 10px;">
                        <i class="fab fa-facebook"></i>
                    </a>
                    <a href="" class="white-text" style="margin: 0 10px;"><i class="fab fa-twitter"></i></a>
                    <a href="" class="white-text" style="margin: 0 10px;"><i class="fab fa-instagram"></i></a>
                </div>
