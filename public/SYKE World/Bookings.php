    ...
    <div class="row grey darken-4 numbers">
      <div class="col l2 s12 hide-on-med-and-small black numbers">
        ...
        <div class="nav-wrapper black">
          ...
          <ul class="left hide-on-med-and-down">
            ...
            <li title="Bookings" class="active orange"><a href="Bookings.php"><img src="bookings.png" class="responsive-img"> Bookings</a></li><br>
      ...
      <div class="col l10 s12 hide-on-med-and-small">
        ...
        <div class="row center black white-text numbers s">
          ...
          <h4 class="orange-text"><i class="small material-icons orange-text">assignment</i> <i class="small material-icons blue-text">hotel</i> Bookings</h4>
            <p class="white-text">Know how popular your rooms and services are and which aren't!</p>
                <div class="tabla">
                      ...
                      <td><?php
                       ...
                       <td><?php
                        ...
                        <td><?php
                            echo $row["createdAt"];
                             ?></td>
                       <td><a href="delete4.php?id=<?php echo $row["roomid"]; ?>">
                         <button type="submit" name="submit" class="btn black white-text">Delete</button></a>
                       </td>
                       <td><a href="checkout.php?id=<?php echo $row["roomNum"]; ?>">
                         <button type="submit" name="submit" class="btn green darken-4 white-text" id="checkout">Checkout</button></a>
                         <style>
                         #checkout:after{
                           color:red
                         }
              ...
              <div class="black white-text">
                <?php echo "Number of Bookings: ".$count; ?>
              </div>
          </div>
        </div>
      </div>
