<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        //create query
        $query = "SELECT * FROM team WHERE email='$email' and password='$password'";
        ...
        if(count($users) === 1) {
            ...
            session_start();
            // var_dump($users);
            $_SESSION['loggedinTeam'] = true;
            $_SESSION['firstnameTeam'] = $firstname;
            $_SESSION['lastnameTeam'] = $lastname;
            $_SESSION['emailTeam'] = $email;
            $_SESSION['photoTeam'] = $photo;
