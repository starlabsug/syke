...
$quer = "SELECT * FROM team where type = 'admin'";
      ...
      <div class="col l2 s12 hide-on-med-and-small black numbers">
        ...
        <div class="nav-wrapper black">
          ...
          <ul class="left hide-on-med-and-down">
            <li title="Administrators" class="active orange"><a href="Admin.php"><img src="admin.png" class="responsive-img"> Administrators</a></li><br>
        ...
        <ul class="sidenav" id="mobile-demo">
          <li class="active"><a href="Admin.php">Administrators</a></li>
      ...
      <div class="col l10 s12 hide-on-med-and-small">
        ...
        <div class="row center black white-text numbers s">
          ...
          <div class="row black white-text numbers main">
            <h4 class="orange-text"><i class="small material-icons blue-text">person</i> Administrators</h4>
                <div class="tabla">
              ...
              <div class="black white-text">
                <?php
                $_SESSION['countadmin'] = $count;
                echo "Number of Admins: ".$count; ?>
              </div>
          </div>
        </div>
      </div>
