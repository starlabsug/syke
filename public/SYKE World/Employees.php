...
$quer = "SELECT * FROM team where type='employee'";
    ...
    <div class="row grey darken-4 numbers">
      <div class="col l2 s12 hide-on-med-and-small black numbers">
        ...
        <div class="nav-wrapper black">
          ...
          <ul class="left hide-on-med-and-down">
            ...
            <li title="Employees" class="active orange"><a href="Employees.php"><img src="employees.png" class="responsive-img"> Employees</a></li><br>
      ...
      <div class="col l10 s12 hide-on-med-and-small">
        ...
        <div class="row center black white-text numbers s">
          ...
          <h4 class="orange-text"><i class="small material-icons blue-text">people</i> Employees</h4>
                <div class="tabla">
                 <table class="stripped grey darken-4 white-text">
                  ...
                  <tbody>
                    <?php if ($result->num_rows>0) {
                     while ($row = $result->fetch_assoc()) { $countemp = $countemp + 1; ?>
                    <tr>
                      <td>	<?php
                      	echo $row["firstname"];
                      	 ?></td>
              ...
              <div class="black white-text">
                <?php 
                $_SESSION['countemployee'] = $countemp;
                echo "Number of Employees: ".$countemp; ?>
              </div>
          </div>
        </div>
      </div>
