      ...
      <div class="col l2 s12 hide-on-med-and-small black numbers">
        ...
        <div class="nav-wrapper black">
          ...
          <ul class="left hide-on-med-and-down">
            ...
            <li title="Your guests" class="active orange"><a href="Guests.php"><img src="guests.png" class="responsive-img"> Guests</a></li><br>
        ...
        <ul class="sidenav" id="mobile-demo">
          ...
          <li class="active"><a href="Guests.php">Guests</a></li>
      ...
      <div class="col l10 s12 hide-on-med-and-small">
        ...
        <div class="row center black white-text numbers s">
          ...
          <div class="row black white-text numbers main">
            <h4 class="orange-text"><i class="small material-icons blue-text">people_outline</i> Guests</h4>
              <div class="tabla">
                 <table class="stripped grey darken-4 white-text">
                  ...
                  <tbody>
                    <?php if ($result->num_rows>0) {
                     while ($row = $result->fetch_assoc()) { $countguest = $countguest + 1; ?>
                    <tr>
                      <td>	<?php
                      	echo $row["firstname"];
                      	 ?></td>
                      <td><?php
                       ...
                       <td><?php
                     	echo $row["createdAt"];
                     	 ?></td>
                       <td><a href="delete.php?id=<?php echo $row["userid"]; ?>">
              ...
              <div class="black white-text">
                  <?php 
                  $_SESSION['countguest'] = $countguest;
                  echo "Number of Guests: ".$countguest; ?>
                </div>
          </div>
        </div>
      </div>
