    ...
    <div class="row grey darken-4 numbers">
      <div class="col l2 s12 hide-on-med-and-small black numbers">
        ...
        <div class="nav-wrapper black">
          ...
          <ul class="left hide-on-med-and-down">
            ...
            <li title="comments" class="active orange"><a href="Comments.php"><img src="comments.svg" class="responsive-img"> Comments</a></li><br>
      ...
      <div class="col l10 s12 hide-on-med-and-small">
        ...
        <div class="row center black white-text numbers s">
          ...
          <h4 class="orange-text"><i class="small material-icons blue-text">message</i> Comments</h4>
            <p class="white-text">Know what your guests say and think about the experience!</p>
              <div class="tabla">
                <table class="stripped grey darken-4 white-text">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="red darken-4"><?php
                    	echo $row["email"];
                    	 ?></td>
                       <td class="green darken-4"><?php
                     	echo $row["comment"];
                     	 ?></td>
                       <td><?php
                     	echo $row["createdAt"];
              ...
              <div class="black white-text">
                <?php echo "Number of Comments: ".$count; ?>
              </div>
          </div>
        </div>
      </div>
