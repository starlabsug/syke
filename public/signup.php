<?php
    ...
    mysqli_free_result($result);
        ...
        if(isset($_POST['submit'])) {
            ...
            if(count($errorA) == 0) {
                $query = "INSERT INTO users(firstname, lastname, email, phonenumber, photo, password) VALUES('$firstname','$lastname','$email','$phonenumber','$photo','$hashed_password')";
    ...
    <div class="content">
        <div class="container">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                ...
                <span>
                            <p class="white-text">Already have an account <a href="<?php echo htmlspecialchars(ROOT_URL); ?>signin.php" class="white-text orange-text text-darken-4">Log In</a></p>
                        </span>
